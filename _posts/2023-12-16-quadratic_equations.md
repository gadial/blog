...
(הוצאת גורם משותף כזו היא בעצם הצעד ההפוך לזה שעושים בחוג הפילוג).

עכשיו, עם הביטוי {% equation %}-qx+pq{% endequation %} שהוא מה שנשאר בסכום הגורף המשותף הוא {% equation %}q{% endequation %}, אז אני מוציא אותו ומקבל
