...
זה מסיים את העניין אם זוכרים מה קורה בדרך כלל בשלב הזה בשיטה ההסתברותית. תוחלת של אינדיקטור היא ההסתברות שהוא יקבל 1, כלומר {% equation %}\text{E}\left[X_{i}\right]=\frac{1}{n-d_{i}}{% endequation %}. לינאריות התוחלת נותנת לנו כעת

{% equation %}\text{E}\left[X\right]=\text{E}\left[\sum_{i=1}^{n}X_{i}\right]=\sum_{i=1}^{n}\text{E}\left[X_{i}\right]=\sum_{i=1}^{n}\frac{1}{n-d_{i}}{% endequation %}
