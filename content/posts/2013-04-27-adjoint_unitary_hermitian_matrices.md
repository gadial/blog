...
לא מאמינים? פשוט תכפילו ותראו... הנוסחה הזו היא מקרה פרטי של המשפט לפיו {% equation %}A^{-1}=\frac{\text{adj}A}{\left|A\right|}{% endequation %} שהראיתי בעבר. עכשיו, באופן כללי מתקיים
