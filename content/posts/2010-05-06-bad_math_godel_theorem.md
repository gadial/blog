...
אז רגע, מה כן קורה בהוכחה של משפט גדל? <a href="http://www.gadial.net/2009/05/10/godel_incompleteness_proof_sketch/">ניסיתי לתאר זאת בפירוט בעבר</a> - השורה התחתונה היא שעבור תורה {% equation %}T{% endequation %} בונים משפט שבדרך מחוכמת ועקיפה מצליח לומר "לא קיימת עבורי הוכחה בתוך התורה {% equation %}T{% endequation %}". מה בין זה ובין משפטים שמוכיחים את עצמם - אין לי מושג.
