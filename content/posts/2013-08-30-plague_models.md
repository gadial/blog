...
<script language="javascript" type="text/javascript" src="{{site.baseurl}}/assets/js/plague/jquery.js"></script>
<script language="javascript" type="text/javascript" src="{{site.baseurl}}/assets/js/plague/jquery.flot.js"></script>
<script language="javascript" type="text/javascript" src="{{site.baseurl}}/assets/js/plague/jquery.flot.time.js"></script>
<script language="javascript" type="text/javascript" src="{{site.baseurl}}/assets/js/plague/jquery.flot.canvas.js"></script>
<script language="javascript" type="text/javascript" src="{{site.baseurl}}/assets/js/plague/plot.js"></script>
