...
<h1>רשימת הסיפורונים של סיפורונובמבר 2022</h1>
<div id="sipuron-list">
...
{%- for author in site.data.sipuron.year_2022.authors -%}
...
<option value="הכל">הכל</option>
{%- for keyword in site.data.sipuron.year_2022.keywords -%}
...
{% endfor %}
  ...
  {%- for sipuron in site.data.sipuron.year_2022.stories -%}
    <li>
