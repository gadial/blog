...
{%- for author in site.data.sipuron.year_2024.authors -%}
...
<option value="הכל">הכל</option>
{%- for keyword in site.data.sipuron.year_2024.keywords -%}
...
{% endfor %}
  ...
  {%- for sipuron in site.data.sipuron.year_2024.stories -%}
    <li>
