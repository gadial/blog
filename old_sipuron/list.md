...
{%- for author in site.data.sipuron.year_2025.authors -%}
...
<option value="הכל">הכל</option>
{%- for keyword in site.data.sipuron.year_2025.keywords -%}
...
{% endfor %}
  ...
  {%- for sipuron in site.data.sipuron.year_2025.stories -%}
    <li>
